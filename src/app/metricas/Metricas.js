...
const Metricas = () => {
  return (
    <>
      ...
      <section className="font-red-hat relative flex items-center justify-center text-white w-full h-full">
        <div className="flex flex-col gap-5 sm:w-full sm:px-5 lg:w-[755px] lg:px-0">
          ...
          <button
            className="rounded-full bg-white font-bold text-primary-50 hover:bg-gray-30 sm:h-12 lg:h-14"
            onClick={() =>
